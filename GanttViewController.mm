...
- (IBAction)callDP:(id)sender
{
	...
	UIBarButtonItem *button1 = [[UIBarButtonItem alloc] initWithTitle:@"Today" style:UIBarButtonItemStyleBordered target:self  action:@selector(gotoToday:)];
...
- (IBAction)ShowCombinationPopup:(id)sender
{
	...
	DatetoolBar.barStyle = UIBarStyleBlackTranslucent;
	UIBarButtonItem *spacer = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil];
	UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(dismissCombinationPicker:)];
...
*/
			...
			NSInteger PR_ID = [resultSet indexForField:@"PR_ID"];
			...
			while ([resultSet moveNext])
				...
				book.PR_ID = [resultSet getString:PR_ID];
				book.PR_NAME = [resultSet getString:PR_NAME];
