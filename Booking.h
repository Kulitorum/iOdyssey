...
@property (nonatomic) NSString  *Resource;		// Visual Effects/ Colorist06
...
@property (nonatomic) NSString  *FIRST_NAME;		// Michael 
@property (nonatomic) NSString  *LAST_NAME;		// Holm
@property (nonatomic) NSString  *NAME;			// Proejct name
@property (nonatomic) NSString  *ACTIVITY;		// Online/CC/Effect
@property (nonatomic) NSString  *BK_Remark;		// remarks
@property (nonatomic) NSString  *Folder_name;		// Project
@property (nonatomic) NSString  *Folder_remark;	// info on project
@property (nonatomic) NSString  *TYPE;			// S=people | V=machines
@property Date  FROM_TIME;
@property Date  TO_TIME;
@property (nonatomic) NSString *CL_NAME;			// client name
@property (nonatomic) NSString *PR_ID;			// client name
@property (nonatomic) NSString *PR_NAME;			// client name
